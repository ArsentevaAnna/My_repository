...
class Company
{
     ...
     * @ORM\Column(type="integer")
     */
    private $quote_num; // Кол-во цитат на 1 платёж
    ...
    public function getTaxplayerNum(): ?string
    {
        return $this->taxplayer_num;
    }

    public function setTaxplayerNum(string $taxplayer_num): self
    {
        $this->taxplayer_num = $taxplayer_num;
    ...
    public function setPeriodEnd(string $period_end): self
    {
